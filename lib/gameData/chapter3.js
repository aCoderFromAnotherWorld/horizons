...
export const IMITATION_ACTIONS = [
  ...
  { taskKey: 'ch3_l4_imitation_3',  modality: 'facial', emoji: '😁', label: 'Big smile',     animType: 'scale',     options: ['😟', '😐', '😯', '😁'], correctIndex: 3 },
  ...
  { taskKey: 'ch3_l4_imitation_6',  modality: 'body',   emoji: '👏', label: 'Clap',          animType: 'scale',     options: ['👐', '🤙', '✌️', '👏'], correctIndex: 3 },
